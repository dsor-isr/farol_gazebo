...
namespace gazebo {
  ...
  class DVLROSPlugin : public ROSBaseModelPlugin {
    ...
    /// \brief DVL Measurement message (used by the farol stack)
    protected: dsor_msgs::Measurement dvlMeasurementMsg;

    /// \brief Additional Measurement ROS topic specific for DVL msgs into farol stack
    protected: ros::Publisher farolStackDVLPub;
