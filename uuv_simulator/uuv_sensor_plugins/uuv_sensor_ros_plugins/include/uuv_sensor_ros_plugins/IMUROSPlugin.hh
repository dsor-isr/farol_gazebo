...
namespace gazebo {
  ...
  class IMUROSPlugin : public ROSBaseModelPlugin {
    ...
    /// \brief IMU Measurement message (used by the farol stack)
    protected: dsor_msgs::Measurement imuMeasurementMsg;

    /// \brief Additional Measurement ROS topic specific for IMU msgs into stack
    protected: ros::Publisher farolStackImuPub;
  };
}
