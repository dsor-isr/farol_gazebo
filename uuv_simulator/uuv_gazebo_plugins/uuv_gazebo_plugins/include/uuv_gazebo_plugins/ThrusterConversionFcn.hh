...
class ConversionFunctionFactory {
  ...
  public: bool RegisterCreator(const std::string& _identifier, ConversionFunctionCreator _creator);
...
#define REGISTER_CONVERSIONFUNCTION_CREATOR(type, creator) const bool type::registeredWithFactory = ConversionFunctionFactory::GetInstance().RegisterCreator(type::IDENTIFIER, creator);
...
class ConversionFunctionBessa : public ConversionFunction {
  ...
  /// \brief Constructor.
  private: ConversionFunctionBessa(double _rotorConstantL, double _rotorConstantR, double _deltaL, double _deltaR);
...
class ConversionFunctionLinearInterp: public ConversionFunction {
  ...
  /// \brief Constructor.
  private: ConversionFunctionLinearInterp(const std::vector<double> &_input, const std::vector<double> &_output);
